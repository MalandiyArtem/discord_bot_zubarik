...
export class ScheduleMessageAdd1713090177572 implements MigrationInterface {
    name = 'ScheduleMessageAdd1713090177572'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "scheduled_message" ("scheduleMessageId" uuid NOT NULL DEFAULT uuid_generate_v4(), "authorId" character varying NOT NULL, "channelId" character varying NOT NULL, "date" TIMESTAMP NOT NULL, "readableDate" character varying NOT NULL, "attachmentUrl" character varying, "message" character varying, "gifUrl" character varying, "guildGuildId" character varying, CONSTRAINT "PK_aa7c458f968f5f098794d1680b2" PRIMARY KEY ("scheduleMessageId"))`);
